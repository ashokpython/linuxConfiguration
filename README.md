...
- The web application is my [Item Catalog project](https://github.com/ashokpython/Book-Item-Catalog) created earlier in this Nanodegree program.
- The database server is [PostgreSQL](https://www.postgresql.org/).

You can visit http://54.188.124.108.xip.io/ or http://ec2-54-188-124-108.us-west-2.compute.amazonaws.com/ for the website deployed.
...
### Step 1: Start a new Ubuntu Linux server instance on Amazon EC2 
  ...
  - Check for instance IPv4 public IP - 54.188.124.108
  - we can download a .pem file and connect with following command
    ```
    ssh -i itemcatalog1.pem ubuntu@54.188.124.108
    ``` 
...
- To check port 2200 wether working or not by `ssh -i itemcatalog1.pem -p 2200 ubuntu@54.188.124.108` 
...
### Step 7: Create an SSH key pair for `grader`
  ...
  - Restart SSH: `sudo service ssh restart`
  - On the local machine, cheking if the grader account working or not by running this command : `ssh -i itemcatalog1.pem -p 2200 grader@54.188.124.108`.
...
- We need to change sqlite to postgresql create_engine in `__init__.py`,`database_setup.py` and `dummybooks.py`,
   ```
...
- Click `Credentials`.
- Create an OAuth Client ID (under the Credentials tab), and add http://54.188.124.108.xip.io and 
http://ec2-54-188-124-108.us-west-2.compute.amazonaws.com/ as authorized JavaScript 
origins.
- Add http://54.188.124.108.xip.io/login,http://54.188.124.108.xip.io/gconnect,http://54.188.124.108.xip.io/callback
...
### Step 13.2: Set up and enable a virtual host
  ...
  ```
  <VirtualHost *:80>
    ServerName 54.188.124.108.xip.io
    ServerAlias ec2-54-188-124-108.us-west-2.compute.amazonaws.com
    ServerAdmin ubuntu@54.188.124.108
...
- Open your browser to http://54.188.124.108 or http://ec2-54-188-124-108.us-west-2.compute.amazonaws.com.
